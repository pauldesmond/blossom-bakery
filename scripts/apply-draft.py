...
# Which page IDs are REGENERATED by scripts/build.py from _pages/*.yml.
# Must mirror build.py's PAGE_META exactly — if it doesn't, edits to a
# regenerated page will silently revert on the next CI run.
GENERATED = {
    "about", "cakes", "childrens-cakes", "customer-reviews",
    "ganache-drip-cakes", "giant-cookies", "handmade-biscuits",
    "numbered-birthday-cakes", "scones",
    "speciality-and-everyday-cakes", "traybakes",
}

# Map page id → file. Mirror the editor's PAGES list.
PAGE_FILES = {
    "index": "index.html",
