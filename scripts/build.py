...
FOOTER = '''<footer class="site-footer">
    <div class="container">
      ...
      <div class="site-footer__bottom" style="margin-top: 6px; font-size: 0.78rem; opacity: 0.7;">
        Looking for a pint? <a href="https://pintpoint.co.uk" rel="noopener" target="_blank" style="color: inherit; text-decoration: underline">PINtPOINT</a> — same family.
      </div>
    </div>
  </footer>'''
