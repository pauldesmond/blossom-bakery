    ...
    <div class="container">
      <div class="site-footer__grid">
        ...
        <div>
          ...
          <p style="margin-top: 16px;"><a href="https://www.foodhygienerankings.co.uk/Establishments/1100840-blossom-bakery-and-handmade-biscuits" rel="noopener" target="_blank" aria-label="Food hygiene rating: 5 stars"><img alt="Food hygiene rating: 5 stars" loading="lazy" src="images/5-star-food-hygiene.svg" width="160" height="79" style="display: block; max-width: 160px;" /></a></p>
        </div>
      </div>
